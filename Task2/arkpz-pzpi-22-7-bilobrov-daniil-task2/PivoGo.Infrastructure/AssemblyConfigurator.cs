...
using PivoGo.Application.Interfaces.Services;
using PivoGo.Application.Options;
using PivoGo.Application.Services;
using PivoGo.Domain.UserAggregate;
using PivoGo.Infrastructure.Database;
using PivoGo.Infrastructure.Repositories;
using EmailService;
...
using ApplicationAssemblyConfigurator = PivoGo.Infrastructure.AssemblyConfigurator;
...
public static class AssemblyConfigurator
{
    ...
    {
        services.AddDbContext<PivoGoContext>(options =>
        ...
        .AddEntityFrameworkStores<PivoGoContext>()
